    ...
    return (
        ...
        <div className='container'>
            <div className="mb-3">
                ...
                <textarea className="form-control" value={text} style={{backgroundColor:props.mode === "dark" ? "#525570" : "white"}} onChange={handleOnChange}id="exampleFormControlTextarea1" rows="3" ></textarea>
            </div>
